...
function init(){
  ...
  if (window.location.href.indexOf('/immigration-certificate-translation/') != -1) {
    document.querySelector("#header-img > section.template_banner .row div").insertAdjacentHTML("afterend", htmlStr);
  } 
  else if (window.location.href.indexOf('/certified-translations-for-official-civil-documents/') != -1) {
    document.querySelector("#header-img > section.template_banner .row div").insertAdjacentHTML("afterend", htmlStr2);
  } 
  // else if (window.location.href.indexOf('/sitemap/') != -1) {
  //   document.querySelector("#header-img > section.template_banner .row div").insertAdjacentHTML("afterend", htmlStr2);
  // } 
}
