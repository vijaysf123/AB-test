...
function init(){
  ...
  document.querySelector("#maincontent > div.container.product-detail.product-wrapper.user-selected > div.row.tile > div.pdp-tile > div.attributes > div.delivery-options > div > div.pt-4 > og-offer > og-when > div > span.auto-deliver-text > span").innerHTML = htmlString;

}
    /* Initialize variation */
    waitForElement("#maincontent > div.container.product-detail.product-wrapper.user-selected > div.row.tile > div.pdp-tile > div.attributes > div.delivery-options > div > div.pt-4 > og-offer > og-when > div > span.auto-deliver-text > span", init, 50, 15000);
  } catch (e) {
