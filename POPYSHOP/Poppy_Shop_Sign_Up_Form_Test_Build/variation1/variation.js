(function() {
    try {
        /* main variables */
        var debug = 0;
        var variation_name = "Subscribe Tickbox Above CTA";
        ...
        function init() {
            ...
            egNewsLetterEle.insertAdjacentHTML("afterend",egCustomHTML);
            ...
            document.querySelector(".eg-auth-container > button").addEventListener("click",function(){
                document.querySelector(".eg-auth-container + div input[type='submit']").click();
            });                   
        }
